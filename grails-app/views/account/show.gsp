	...
	<body>
		...
		<div id="show-account" class="content scaffold-show" role="main">
			...
			<ol class="property-list account">
				...
				<g:if test="${accountInstance?.typeAccount}">
				<li class="fieldcontain">
					<span id="typeAccount-label" class="property-label"><g:message code="account.typeAccount.label" default="Type Account" /></span>
					
						<span class="property-value" aria-labelledby="typeAccount-label"><g:fieldValue bean="${accountInstance}" field="typeAccount"/></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="account.user.label" default="User" /></span>
						...
						<g:each in="${accountInstance.user}" var="u">
